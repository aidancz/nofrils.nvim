...
so we clear the definitions of all existing highlight groups, but plugins loaded later may introduce new highlight groups. in that case, we can use the `clear` function to remove them
